"""
Floor in Binary Search Tree (BST): Given a Binary Search Tree and a number x, find floor of x in the given BST.
...
def findFloor(root, inp):
    ...
    if root.key > inp:
        return findFloor(root.left, inp)

    fc = findFloor(root.right, inp)
